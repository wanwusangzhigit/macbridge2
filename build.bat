...
cl /nologo /w /O2 /I"%SRC_DIR%" "%SRC_DIR%\macho.c" "%SRC_DIR%\syscall.c" "%SRC_DIR%\vfs.c" "%SRC_DIR%\dyld.c" "%SRC_DIR%\platform.c" "%SRC_DIR%\app_bundle.c" "%SRC_DIR%\dmg.c" "%SRC_DIR%\hfs.c" "%SRC_DIR%\util.c" "%SRC_DIR%\app_loader.c" /Fe"%BIN_DIR%\app_loader.exe"
